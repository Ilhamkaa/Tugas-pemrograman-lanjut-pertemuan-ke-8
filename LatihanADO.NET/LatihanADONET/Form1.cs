    ...
    public partial class Form1 : Form
    {
        ...
        private SQLiteConnection GetOpenConnection()
        {
            ...
            try // penggunaan blok try-catch untuk penanganan error
            {
                ...
                string dbName = @"Z:\SEMESTER 3\PEMROGRAMAN LANJUT\Module Praktikum 08 -20231109T153026Z-001\Module Praktikum 08 (ADO.NET)\LatihanADO.NET\Database\DbPerpustakaan.db";
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            DialogResult dialogResult = MessageBox.Show("Apakah data mahasiswa ingin didelete ?", "Konfirmasi",
            ...
            // Jika user memilih "No" pada konfirmasi, tidak lakukan penghapusan
        }
